...
<main>
		<form action="sellerInsertProduct" method="post" enctype="multipart/form-data"
		...
		<table class="table table-sm table-bordered">
			...
			<tr>
				...
				<td><input type="number" size="120" maxlength="7"
					name="dis_price" id="dis_price" placeholder="최대 MAX할인가격입력" required></td>
			</tr>
			<tr>
				<th>판매 개수</th>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="file" name="uploadFile" id="uploadFile"
								accept="image/*" onchange="uploadFileCheck()" required="required"> <small
