				...
				<form action="sellerInsertProduct" method="post"
					...
					<table class="table table-sm table-bordered">
						...
						<tr>
							...
							<td><select name="ca_no" id="mCate"
								onchange="subCateChange()">
						...
						<tr>
							<th class="sub-cate"><label for="sCate">서브카테고리</label></th>
							<td><select name="sca_no" id="sCate">
						...
						<tr>
							<th>제조회사</th>
							<td><input type="text" size="120" maxlength="7"
								name="company" id="company" placeholder="제조회사 입력" required></td>
						</tr>
						<tr>
							<th>상품명</th>
						...
						<tr>
							<th>상세 설명</th>
							<td><textarea name="content" id="content" cols="119"
									rows="3" maxlength="1000"></textarea></td>
						</tr>
